...
namespace CountriesWebApp.Infrastructure.Migrations
{
    /// <inheritdoc />
    public partial class AchievementInitialCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "FLAG_MASTER_1", "50 Points without loss.", 50, "Flag Master I" },
                    { 2, "FLAG_MASTER_2", "80 Points without loss.", 80, "Flag Master II" },
